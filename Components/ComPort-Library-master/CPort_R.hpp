...
// (DO NOT EDIT: machine generated header) 'CPort_R.dpk' rev: 35.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_CPORT_R)
using namespace Cport_r;
#endif
#pragma pack(pop)
#pragma option pop
