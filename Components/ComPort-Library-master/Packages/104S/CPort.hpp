...
// (DO NOT EDIT: machine generated header) 'CPort.pas' rev: 36.00 (Windows)
...
typedef void __fastcall (__closure *TComExceptionEvent)(System::TObject* Sender, TComExceptions TComException, System::UnicodeString ComportMessage, __int64 WinError, System::UnicodeString WinMessage);
...
{
public:
	Winapi::Windows::TOverlapped Overlapped;
	TOperationKind Kind;
	void *Data;
	int Size;
};
...
private:
	...
	Winapi::Windows::THandle FStopEvent;
	TComEvents FEvents;
...
private:
	...
	Winapi::Windows::THandle FWindow;
	int FUpdateCount;
	...
	TComExceptionEvent FOnException;
	unsigned FCodePage;
	...
	void __fastcall SetPortW(const TPort Value);
	...
	void __fastcall CallException(System::Word AnException, const __int64 WinError = 0LL);
	void __fastcall SetEofChar(const System::WideChar Value);
...
public:
	...
	int __fastcall WriteStr(System::UnicodeString Str);
	int __fastcall WriteAnsiStr(System::AnsiString Str);
	int __fastcall WriteUnicodeString(const System::UnicodeString Str);
	int __fastcall WriteAsync(const void *Buffer, int Count, PAsync &AsyncPtr);
	int __fastcall WriteStrAsync(System::UnicodeString &Str, PAsync &AsyncPtr);
	int __fastcall WriteAnsiStrAsync(System::AnsiString &Str, PAsync &AsyncPtr);
	int __fastcall Read(void *Buffer, int Count);
	int __fastcall ReadStr(System::UnicodeString &Str, int Count);
	int __fastcall ReadAnsiStr(System::AnsiString &Str, int Count);
	int __fastcall ReadUnicodeString(System::UnicodeString &Str, int Count);
	int __fastcall ReadAsync(void *Buffer, int Count, PAsync &AsyncPtr);
	int __fastcall ReadStrAsync(System::AnsiString &Str, int Count, PAsync &AsyncPtr);
	int __fastcall WaitForAsync(PAsync &AsyncPtr);
	bool __fastcall IsAsyncCompleted(PAsync AsyncPtr);
	void __fastcall WaitForEvent(TComEvents &Events, Winapi::Windows::THandle StopEvent, int Timeout);
	...
	__property TPort Port = {read=FPort, write=SetPortW};
	...
	__property System::WideChar EofChar = {read=FEofChar, write=SetEofChar, default=0};
	...
	__property TComExceptionEvent OnException = {read=FOnException, write=FOnException};
	__property unsigned CodePage = {read=FCodePage, write=FCodePage, default=0};
};
...
__published:
	...
	__property EofChar = {default=0};
	__property EventChar = {default=0};
	__property Events;
	__property Buffer;
	__property FlowControl;
	__property Timeouts;
	__property StoredProps;
	__property TriggersOnRxChar;
...
public:
	/* Exception.CreateFmt */ inline __fastcall EComPort(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EComPort(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EComPort(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EComPort(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EComPort(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EComPort(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EComPort(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EComPort(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST int WaitInfinite = int(-1);
static _DELPHI_CONST System::Int8 CError_OpenFailed = System::Int8(0x1);
static _DELPHI_CONST System::Int8 CError_WriteFailed = System::Int8(0x2);
static _DELPHI_CONST System::Int8 CError_ReadFailed = System::Int8(0x3);
static _DELPHI_CONST System::Int8 CError_InvalidAsync = System::Int8(0x4);
static _DELPHI_CONST System::Int8 CError_PurgeFailed = System::Int8(0x5);
static _DELPHI_CONST System::Int8 CError_AsyncCheck = System::Int8(0x6);
static _DELPHI_CONST System::Int8 CError_SetStateFailed = System::Int8(0x7);
static _DELPHI_CONST System::Int8 CError_TimeoutsFailed = System::Int8(0x8);
static _DELPHI_CONST System::Int8 CError_SetupComFailed = System::Int8(0x9);
static _DELPHI_CONST System::Int8 CError_ClearComFailed = System::Int8(0xa);
static _DELPHI_CONST System::Int8 CError_ModemStatFailed = System::Int8(0xb);
static _DELPHI_CONST System::Int8 CError_EscapeComFailed = System::Int8(0xc);
static _DELPHI_CONST System::Int8 CError_TransmitFailed = System::Int8(0xd);
static _DELPHI_CONST System::Int8 CError_ConnChangeProp = System::Int8(0xe);
static _DELPHI_CONST System::Int8 CError_EnumPortsFailed = System::Int8(0xf);
static _DELPHI_CONST System::Int8 CError_StoreFailed = System::Int8(0x10);
static _DELPHI_CONST System::Int8 CError_LoadFailed = System::Int8(0x11);
static _DELPHI_CONST System::Int8 CError_RegFailed = System::Int8(0x12);
static _DELPHI_CONST System::Int8 CError_LedStateFailed = System::Int8(0x13);
static _DELPHI_CONST System::Int8 CError_ThreadCreated = System::Int8(0x14);
static _DELPHI_CONST System::Int8 CError_WaitFailed = System::Int8(0x15);
static _DELPHI_CONST System::Int8 CError_HasLink = System::Int8(0x16);
static _DELPHI_CONST System::Int8 CError_RegError = System::Int8(0x17);
static _DELPHI_CONST System::Int8 CError_PortNotOpen = System::Int8(0x18);
static _DELPHI_CONST System::Int8 CError_PortDisconnected = System::Int8(0x19);
extern DELPHI_PACKAGE System::UnicodeString __fastcall ComErrorsToStr(TComErrors Errors);
