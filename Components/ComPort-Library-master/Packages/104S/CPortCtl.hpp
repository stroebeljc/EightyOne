...
// (DO NOT EDIT: machine generated header) 'CPortCtl.pas' rev: 36.00 (Windows)
...
private:
	...
	void __fastcall SetGlyph(const int Index, TLedBitmap* const Value);
	...
	Winapi::Windows::TPoint __fastcall CalcBitmapPos();
	TLedBitmap* __fastcall BitmapToDraw();
...
private:
	...
	TTermCaret FCaret;
	Winapi::Windows::TPoint FCaretPos;
	Winapi::Windows::TPoint FSaveCaret;
	bool FCaretCreated;
	Winapi::Windows::TPoint FTopLeft;
	int FCaretHeight;
	...
	void __fastcall InvalidatePortion(const Winapi::Windows::TRect &ARect);
	...
	void __fastcall SetScrollBars(const Vcl::Stdctrls::TScrollStyle Value);
	...
	void __fastcall PaintTerminal(const Winapi::Windows::TRect &Rect);
...
public:
	...
	__property Vcl::Stdctrls::TScrollStyle ScrollBars = {read=FScrollBars, write=SetScrollBars, nodefault};
