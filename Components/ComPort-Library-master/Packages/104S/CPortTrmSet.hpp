...
// (DO NOT EDIT: machine generated header) 'CPortTrmSet.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TCustomForm.CreateScaledNew */ inline __fastcall virtual TComTrmSetForm(System::Classes::TComponent* AOwner, int ADPI, int Dummy) : Vcl::Forms::TForm(AOwner, ADPI, Dummy) { }
