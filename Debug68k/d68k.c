...
"\n"
"The current version of this code can be obtained at:\n"
"(home page pending)\n"
;
...
static int __cdecl compare_nof_true_bits(const void *aptr, const void *bptr);
...
static int __cdecl compare_nof_true_bits(const void *aptr, const void *bptr)
{
   ...
   return b - a; /* reversed to get great'st to least sorting */
}
