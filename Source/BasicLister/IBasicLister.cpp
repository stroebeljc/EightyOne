...
String IBasicLister::RenderLineAsText(LineInfo& lineInfo, bool outputRemTokensAsCharacterCodes, bool outputStringTokensAsCharacterCodes, bool outputNonAsciiAsCharacterCodes, bool outputVariableNamesInLowercase, bool outputInZxTokenFormat, bool limitLineLengths, bool outputFullWidthLineNumbers)
{
        String lineText = "";

        String lineNumber = FormatLineNumber(lineInfo.lineNumber, outputFullWidthLineNumbers);
...
bool IBasicLister::RenderTokenAsText(int& address, int& lengthRemaining, bool& lastKeywordEndedWithSpace, String& zxCharacter, bool& outputLineAsControlCodes, bool outputRemTokensAsCharacterCodes, bool outputStringTokensAsCharacterCodes, bool outputNonAsciiAsCharacterCodes, bool outputVariableNamesInLowercase, bool outputInZxTokenFormat, bool& withinQuotes, bool& withinRem)
{
        unsigned char c = (unsigned char)getbyte(address);
        address++;
        lengthRemaining--;
...
String IBasicLister::FormatLineNumber(int lineNumber, bool outputFullWidthLineNumbers)
{
