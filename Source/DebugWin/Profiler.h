...
private:	// User declarations
        void __fastcall UpdateItem(TListItem* item, String tag, class ProfileDetail& pd);
        void __fastcall SampleEditCompleteImpl(bool valid, String tag);
        int Count();
...
public:		// User declarations
        ...
        static void SampleEditComplete(bool valid, String tag);
