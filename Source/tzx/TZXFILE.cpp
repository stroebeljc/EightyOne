...
String TTZXFile::GetBlockName(int BlockNo)
{
        int i, len, BlockID;
...
String TTZXFile::GetBlockType(int BlockNo)
{
        switch(Tape[BlockNo].BlockID)
        {
        case 0x30:
...
String TTZXFile::GetBlockLength(int BlockNo)
{
        String value;
        int len=-1;
...
String TTZXFile::GetFName(int BlockNo)
{
        String Name="";
        char *p,c;
        int i=32;
